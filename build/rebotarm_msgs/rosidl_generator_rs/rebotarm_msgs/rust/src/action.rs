...
pub struct MoveToPose_Result {
    ...
    // This member is not documented.
    #[allow(missing_docs)]
    pub final_pose: geometry_msgs::msg::Pose,
...
impl rosidl_runtime_rs::Message for MoveToPose_Result {
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        final_pose: geometry_msgs::msg::Pose::into_rmw_message(std::borrow::Cow::Owned(msg.final_pose)).into_owned(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
      success: msg.success,
        message: msg.message.as_str().into(),
        final_pose: geometry_msgs::msg::Pose::into_rmw_message(std::borrow::Cow::Borrowed(&msg.final_pose)).into_owned(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      ...
      final_pose: geometry_msgs::msg::Pose::from_rmw_message(msg.final_pose),
    }
  }
}
...
#[link(name = "rebotarm_msgs__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_action_type_support_handle__rebotarm_msgs__action__MoveToPose() -> *const std::ffi::c_void;
}

// Corresponds to rebotarm_msgs__action__MoveToPose
#[allow(missing_docs, non_camel_case_types)]
...
impl rosidl_runtime_rs::Action for MoveToPose {
  ...
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_action_type_support_handle__rebotarm_msgs__action__MoveToPose() }
  }
