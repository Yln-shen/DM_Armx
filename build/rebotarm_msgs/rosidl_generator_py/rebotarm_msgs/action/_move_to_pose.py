    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rebotarm_msgs.action.MoveToPose_Goal')
            logger.debug(
...
class Metaclass_MoveToPose_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'rebotarm_msgs.action.MoveToPose_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveToPose_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'rebotarm_msgs.action.MoveToPose_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveToPose_SendGoal_Request(metaclass=Metaclass_MoveToPose_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'rebotarm_msgs/MoveToPose_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['rebotarm_msgs', 'action'], 'MoveToPose_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from rebotarm_msgs.action._move_to_pose import MoveToPose_Goal
...
class MoveToPose_SendGoal_Event(metaclass=Metaclass_MoveToPose_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rebotarm_msgs/MoveToPose_SendGoal_Request, 1>',
        'response': 'sequence<rebotarm_msgs/MoveToPose_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rebotarm_msgs', 'action'], 'MoveToPose_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rebotarm_msgs', 'action'], 'MoveToPose_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rebotarm_msgs.action import MoveToPose_SendGoal_Request
    ...
    def response(self, value):
        if self._check_fields:
            from rebotarm_msgs.action import MoveToPose_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_MoveToPose_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'rebotarm_msgs.action.MoveToPose_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from rebotarm_msgs.action import _move_to_pose
...
class MoveToPose_SendGoal(metaclass=Metaclass_MoveToPose_SendGoal):
    from rebotarm_msgs.action._move_to_pose import MoveToPose_SendGoal_Request as Request
    from rebotarm_msgs.action._move_to_pose import MoveToPose_SendGoal_Response as Response
    from rebotarm_msgs.action._move_to_pose import MoveToPose_SendGoal_Event as Event
...
class MoveToPose_GetResult_Response(metaclass=Metaclass_MoveToPose_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'rebotarm_msgs/MoveToPose_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['rebotarm_msgs', 'action'], 'MoveToPose_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from rebotarm_msgs.action._move_to_pose import MoveToPose_Result
...
class MoveToPose_GetResult_Event(metaclass=Metaclass_MoveToPose_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<rebotarm_msgs/MoveToPose_GetResult_Request, 1>',
        'response': 'sequence<rebotarm_msgs/MoveToPose_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rebotarm_msgs', 'action'], 'MoveToPose_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rebotarm_msgs', 'action'], 'MoveToPose_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rebotarm_msgs.action import MoveToPose_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from rebotarm_msgs.action import MoveToPose_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_MoveToPose_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'rebotarm_msgs.action.MoveToPose_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveToPose_GetResult(metaclass=Metaclass_MoveToPose_GetResult):
    from rebotarm_msgs.action._move_to_pose import MoveToPose_GetResult_Request as Request
    from rebotarm_msgs.action._move_to_pose import MoveToPose_GetResult_Response as Response
    from rebotarm_msgs.action._move_to_pose import MoveToPose_GetResult_Event as Event
...
class Metaclass_MoveToPose_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'rebotarm_msgs.action.MoveToPose_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class MoveToPose_FeedbackMessage(metaclass=Metaclass_MoveToPose_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'rebotarm_msgs/MoveToPose_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['rebotarm_msgs', 'action'], 'MoveToPose_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from rebotarm_msgs.action._move_to_pose import MoveToPose_Feedback
...
class MoveToPose(metaclass=Metaclass_MoveToPose):
    ...
    from rebotarm_msgs.action._move_to_pose import MoveToPose_Goal as Goal
    # The result message defined in the action definition.
    from rebotarm_msgs.action._move_to_pose import MoveToPose_Result as Result
    # The feedback message defined in the action definition.
    from rebotarm_msgs.action._move_to_pose import MoveToPose_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from rebotarm_msgs.action._move_to_pose import MoveToPose_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from rebotarm_msgs.action._move_to_pose import MoveToPose_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from rebotarm_msgs.action._move_to_pose import MoveToPose_FeedbackMessage as FeedbackMessage
