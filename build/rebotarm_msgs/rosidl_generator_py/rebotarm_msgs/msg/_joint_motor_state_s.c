...
bool rebotarm_msgs__msg__joint_motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rebotarm_msgs.msg._joint_motor_state.JointMotorState", full_classname_dest, 52) == 0);
  }
  rebotarm_msgs__msg__JointMotorState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of JointMotorState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rebotarm_msgs.msg._joint_motor_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointMotorState");
