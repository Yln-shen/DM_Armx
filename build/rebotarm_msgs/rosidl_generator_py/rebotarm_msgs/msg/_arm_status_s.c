...
bool rebotarm_msgs__msg__arm_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rebotarm_msgs.msg._arm_status.ArmStatus", full_classname_dest, 39) == 0);
  }
  rebotarm_msgs__msg__ArmStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // control_loop_active
    PyObject * field = PyObject_GetAttrString(_pymsg, "control_loop_active");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->control_loop_active = (Py_True == field);
    Py_DECREF(field);
  }
  {  // state_machine
    ...
    rosidl_runtime_c__String__assign(&ros_message->state_machine, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // joint_names
  ...
  {  // per_joint_status_code
    PyObject * field = PyObject_GetAttrString(_pymsg, "per_joint_status_code");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->per_joint_status_code.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'per_joint_status_code'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * rebotarm_msgs__msg__arm_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rebotarm_msgs.msg._arm_status");
  ...
  {  // control_loop_active
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->control_loop_active ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "control_loop_active", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // state_machine
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->state_machine.data,
      strlen(ros_message->state_machine.data),
      "replace");
    if (!field) {
      return NULL;
    }
  ...
  {  // per_joint_status_code
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "per_joint_status_code");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->per_joint_status_code.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->per_joint_status_code.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->per_joint_status_code.size * sizeof(uint8_t));
      assert(data != NULL);
