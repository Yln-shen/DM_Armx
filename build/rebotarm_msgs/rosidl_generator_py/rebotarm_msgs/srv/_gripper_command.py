...
class Metaclass_GripperCommand_Event(type):
    """Metaclass of message 'GripperCommand_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__gripper_command__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__gripper_command__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__gripper_command__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__gripper_command__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__gripper_command__event
...
class GripperCommand_Event(metaclass=Metaclass_GripperCommand_Event):
    """Message class 'GripperCommand_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rebotarm_msgs/GripperCommand_Request, 1>',
        'response': 'sequence<rebotarm_msgs/GripperCommand_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rebotarm_msgs', 'srv'], 'GripperCommand_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rebotarm_msgs', 'srv'], 'GripperCommand_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rebotarm_msgs.srv import GripperCommand_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GripperCommand_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GripperCommand_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rebotarm_msgs.srv import GripperCommand_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GripperCommand_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GripperCommand_Response'"
...
class Metaclass_GripperCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rebotarm_msgs.srv import _gripper_command
            ...
            if _gripper_command.Metaclass_GripperCommand_Event._TYPE_SUPPORT is None:
                _gripper_command.Metaclass_GripperCommand_Event.__import_type_support__()


class GripperCommand(metaclass=Metaclass_GripperCommand):
    from rebotarm_msgs.srv._gripper_command import GripperCommand_Request as Request
    from rebotarm_msgs.srv._gripper_command import GripperCommand_Response as Response
    from rebotarm_msgs.srv._gripper_command import GripperCommand_Event as Event
